<div x-cloak
    ...
    <div @click.away="form = false" class="relative w-full h-full max-w-2xl px-4 md:h-auto overflow-y-auto">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <form class="p-6 space-y-6 max-h-[500px] overflow-y-auto" wire:submit.prevent=@if ($update) 'update'
                @else 'save' @endif>
                {{ $slot }}
