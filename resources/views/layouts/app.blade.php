        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <p class="">You are currently login as
                        <span class="">{{ Auth()->user()->current_role }}</span>
                    </p>
                </div>
                ...
                <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                    <div
                        ...
                        <ul class="pb-2 space-y-2">
                            ...
                            @if (in_array('companies-read', $permissions))
                                <li class="">
                                    <a href="{{ route('companies') }}"
                                        ...
                                        <i class="fa-regular text-[20px] fa-registered dark:text-gray-400"></i>
                                        <span class="ml-3 capitalize" sidebar-toggle-item>companies</span>
                                    </a>
                                </li>
                            @endif
                            @if (in_array('parks-read', $permissions))
                                <li class="">
                                    <a href="{{ route('parks') }}"
                                        class="flex items-center dark:text-gray-200 dark:hover:bg-gray-700 hover:text-white rounded-lg p-2 text-base {{ request()->is('admin/parks') ? 'active' : '' }} rounded-lg hover:bg-primary group">
                                        <i class="fa-solid text-[20px] fa-truck-ramp-box dark:text-gray-400"></i>
                                        <span class="ml-3 capitalize" sidebar-toggle-item>parks</span>
                                    </a>
                                </li>
                            @endif
                            @if (in_array('routes-read', $permissions))
                                <li class="">
                                    <a href="{{ route('routes') }}"
                                        class="flex items-center dark:text-gray-200 dark:hover:bg-gray-700 hover:text-white rounded-lg p-2 text-base {{ request()->is('admin/routes') ? 'active' : '' }} rounded-lg hover:bg-primary group">
                                        <i class="fa-solid text-[20px] fa-truck-field-un dark:text-gray-400"></i>
                                        <span class="ml-3 capitalize" sidebar-toggle-item>routes</span>
                                    </a>
                                </li>
                            @endif
                            @if (in_array('users-read', $permissions))
                                <li class="">
                                    <a href="{{ route('agents') }}"
                                        class="flex items-center dark:text-gray-200 dark:hover:bg-gray-700 hover:text-white rounded-lg p-2 text-base {{ request()->is('admin/users') ? 'active' : '' }} rounded-lg hover:bg-primary group">
                                        <i class="fa-solid text-[20px] fa-id-card dark:text-gray-400"></i>
                                        <span class="ml-3 capitalize" sidebar-toggle-item>agents</span>
                                    </a>
                                </li>
                            @endif
                            @if (in_array('vehicles-read', $permissions))
                                <li class="">
                                    <a href="{{ route('vehicles') }}"
                                        class="flex items-center dark:text-gray-200 dark:hover:bg-gray-700 hover:text-white rounded-lg p-2 text-base {{ request()->is('transport/vehicles') ? 'active' : '' }} rounded-lg hover:bg-primary group">
                                        <i class="fa-regular text-[20px] fa-bus dark:text-gray-400"></i>
                                        <span class="ml-3 capitalize" sidebar-toggle-item>Vehicles</span>
                                    </a>
                                </li>
                            @endif
                            @if (in_array('passengers-read', $permissions))
                                <li class="">
                                    <a href="{{ route('passengers') }}"
                                        class="flex items-center dark:text-gray-200 dark:hover:bg-gray-700 hover:text-white rounded-lg p-2 text-base {{ request()->is('transport/passengers') ? 'active' : '' }} rounded-lg hover:bg-primary group">
                                        <i class="fa-regular text-[20px] fa-address-book dark:text-gray-400"></i>
                                        <span class="ml-3 capitalize" sidebar-toggle-item>passengers</span>
                                    </a>
                                </li>
                            @endif
                            @if (in_array('trips-read', $permissions))
                                <li class="">
                                    <a href="{{ route('trips') }}"
                                        class="flex items-center dark:text-gray-200 dark:hover:bg-gray-700 hover:text-white rounded-lg p-2 text-base {{ request()->is('transport/trips') ? 'active' : '' }} rounded-lg hover:bg-primary group">
                                        <i class="fa-regular text-[18px] fa-plane-departure dark:text-gray-400"></i>
                                        <span class="ml-3 capitalize" sidebar-toggle-item>trips</span>
                                    </a>
                                </li>
                            @endif
                            <li>
