...
<head>
    ...
    <meta name="twitter:title" content="Binters Error Page - Flowbite">
    <meta name="twitter:description" content="Error gae">
    <meta name="twitter:image" content="{{ asset('img/logo.png') }}">

    <!-- Facebook -->
    <meta property="og:url" content="{{ env('APP_NAME') }}">
    <meta property="og:title" content="Binters 404 Not Found Page ">
...
<body class="bg-gray-50 dark:bg-gray-800">
    ...
    <main class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center h-screen px-6 mx-auto xl:px-0 dark:bg-gray-900">
            <div class="block w-3/4 md:max-w-xs lg:max-w-sm 2xl:max-w-lg">
                @yield('image')
            </div>
            <div class="text-center xl:max-w-4xl">
                ...
                <p class="max-w-xl mb-5 text-base font-normal text-gray-500 lg:max-w-2xl md:text-lg dark:text-gray-400">
                    @yield('message')</p>
